...
public class BookStoreExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ex.getBindingResult().getGlobalErrors()
                .forEach(globalErros -> errors.add(
                        "Object" + globalErros.getObjectName() + " " + globalErros.getDefaultMessage()));
        return buildResponseEntity(HttpStatus.BAD_REQUEST,"Informe argument errors", errors);
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        return buildResponseEntity(
                ...
                "Malfond JSON body and/or field error",
